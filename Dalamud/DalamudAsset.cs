...
public enum DalamudAsset
{
    ...
    ///     Nothing.
    /// </summary>
    [DalamudAsset(DalamudAssetPurpose.Empty, [])]
    Unspecified = 0,

    /// <summary>
    ///     <see cref="DalamudAssetPurpose.TextureFromRaw" />: A texture that is completely transparent.
    /// </summary>
    [DalamudAsset(DalamudAssetPurpose.TextureFromRaw, [0, 0, 0, 0, 0xFF, 0xFF, 0xFF, 0xFF])]
    ...
    /// </summary>
    [DalamudAsset(DalamudAssetPurpose.TextureFromRaw, [0xFF, 0xFF, 0xFF, 0xFF, 0, 0, 0, 0])]
    [DalamudAssetRawTexture(4, 4, DXGI_FORMAT.DXGI_FORMAT_BC1_UNORM, 8)]
    White4X4 = 1014,
